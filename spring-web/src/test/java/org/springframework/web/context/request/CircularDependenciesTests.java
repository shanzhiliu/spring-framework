...
import org.springframework.tests.sample.beans.StudentA;
import org.springframework.tests.sample.beans.StudentB;
...
public class CircularDependenciesTests {
	...
	public void setup() throws Exception {
		...
		reader.loadBeanDefinitions(new ClassPathResource("CircularDependenciesTests.xml", getClass()));
	...
	public void requestScopedInnerBeanDestroyedWhileContainedBySingleton() throws Exception {
		...
		StudentA studentA = (StudentA) this.beanFactory.getBean("studentA");
//		StudentB studentB = (StudentB) this.beanFactory.getBean("studentB");
